    ...
    <div className={styles.Footer} >
      <div className={styles.Footer_container} >
        ...
        <div className={styles.Footer_text}>
          Copyright &nbsp;<a target='_blank' rel="noreferrer" href='https://discord.gg/trooprz'>Trooprz</a>  © 2023  | Developed by CRMax | Powered by &nbsp;<a target='_blank' rel="noreferrer" href='https://witnet.io/'>Witnet</a>
        </div>
      </div>
    </div>
  )
